...
public class WechatDict {
	 ...
	 * 预约成功模版id
	 */
	public static final String TEMPLATE_APPOINTMENT_SUCCESS = "hgOXWcv0daobJ2kEob3xlVV7fP4b8RFex_LlbfWbI0s"; 
	/**
	 * 预约到期模版id
	 */
	public static final String TEMPLATE_APPOINTMENT_EXPIRES = "9skhVE_e2X9a3_slcPo2Gqmh8_0AhpguQqjZGnpkavE"; 
	/**
	 * 事件提醒模版id
	 */
	public static final String TEMPLATE_EVENT = "avhmeFNqvoPkr8Q15C1VVIjzhhitDJjlSut2I01FC44";
	 ...
	 * 获取access_token
	 */
	public static final String GET_ACCESS_TOKENURL = "https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=APPID&secret=APPSECRET";
	 ...
	 *  刷新网页授权
	 */
	public static final String GET_REFRESH_TOKEN_URL = "https://api.weixin.qq.com/sns/oauth2/refresh_token?appid=APPID&grant_type=refresh_token&refresh_token=REFRESH_TOKEN";
	 ...
	 *  获取用户基本信息
	 */
	public static final String GET_OPEN_INFO_URL = "https://api.weixin.qq.com/cgi-bin/user/info?access_token=ACCESS_TOKEN&openid=OPENID&lang=zh_CN";
	 ...
	 *  主动发送文本消息给个人微信
	 */
	public static final String SEND_TXT_MESSAGE_URL = "https://api.weixin.qq.com/cgi-bin/message/custom/send?access_token=ACCESS_TOKEN";
